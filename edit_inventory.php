...
if (isset($_GET['id'])) {
    ...
    $fetchInventoryQuery = "SELECT * FROM inventory WHERE id = $inventoryId";
    $fetchInventoryResult = $conn->query($fetchInventoryQuery);

    if ($fetchInventoryResult->num_rows > 0) {
        $inventoryDetails = $fetchInventoryResult->fetch_assoc();
    } else {
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card bg-[#ececec]">
                                <div class="card-header  bg-[#aeb3b3]">
                                    <h3 class="card-title"><i class="fas fa-keyboard"></i> Edit Inventory Details</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" class="form-control" id="equipment" name="equipment"
                                                    placeholder="Enter equipment name" required value="<?php echo $inventoryDetails['equipment']; ?>">
                                            </div>
                                            <div class="col-sm-6">
                                                <label for="purchase">Purchase Date</label>
                                                <input type="date" class="form-control" id="purchase" name="purchase" value="<?php echo $inventoryDetails['purchase_date']; ?>" required>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-sm-6">
