  ...
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        ...
        } elseif (strpos($_SERVER['REQUEST_URI'], 'edit_workout.php') !== false) {
          $pageTitle = 'Edit Workout Program';
        ...
        } elseif (strpos($_SERVER['REQUEST_URI'], 'manage_workout.php') !== false) {
          if ($_SESSION['role'] == 'admin') {
            $pageTitle = 'Manage Workout Program';
          } else {
            $pageTitle = 'Workout Program List';
          }
        ...
        elseif (strpos($_SERVER['REQUEST_URI'], 'user_qr_code.php') !== false) {
          ...
          $pageTitle = 'Dashboard';
        } elseif (strpos($_SERVER['REQUEST_URI'], 'scanner.php') !== false) {
          $pageTitle = 'Scanner';
